			...
			// add new row by type of table
            	    ...
            	    if($val->name=="logid")
                    	...
                    	elseif($val->name=="meta" && $resultmetacount>0 && $rows[$val->name]!=null)
                    	{
                    	    ...
                    	    $logtablebody.="<td style=\"width:1%;\"><a href=\"getblob.php?logid=$logid\" target=\"_blank\"><img src=\"getblob.php?logid=$logid&preview=true\" title=\"Open Image\" alt=\"Open Image\"></a></td>";
